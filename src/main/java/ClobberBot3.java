...
/**
 * This bot keeps track of the shot clock, and automatically shoots if it can. This prevents wasted attempts to shoot,
 * while at the same time shooting as much as possible. Otherwise, it tends to move in the same direction it moved
 * before.
 */
