...
/**
 * This class is used by the Clobber game to convey information to the ClobberBots in the game. It tells the bot about
 * its current position, the position of other bots, and the position of bullets in the world.
 */
