...
//				drawBulletTrajectory(g, bul.getStaticCopy(), i, j);
            }
        }

		protected void drawBulletTrajectory(Graphics g, BulletPoint2D bulletPoint, int x, int y) {
			g.setColor(Color.red);
			int addAmount = 600;
			int xAdd = bulletPoint.getXPlus() == 0 ? 0 : bulletPoint.getXPlus() < 0 ? -addAmount : addAmount;
			int yAdd = bulletPoint.getYPlus()  == 0 ? 0 : bulletPoint.getYPlus() < 0 ? -addAmount : addAmount;
